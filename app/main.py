  ...
  <div class="container">
    <div class="card">
      ...
      <form action="/upload-resume" method="post" enctype="multipart/form-data">
        ...
        <textarea name="job_description" id="job_description" placeholder="Paste the job post to tailor feedback"></textarea>
...
async def upload_resume(
    ...
    try:
        ...
        parser = ResumeParser()
        # 🔒 Pass None for filename → sniff bytes only
